...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--sequences", nargs="+", required=True, help="sequences to be sanitized"
    )
    parser.add_argument(
        "--strip-prefixes",
        nargs="+",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="exit with an error when the same strain is detected multiple times with different sequences. By default, use the first occurrence of each duplicated sequence.",
    )
